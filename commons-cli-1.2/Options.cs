...
namespace org.apache.commons.cli
{
    ...
    public class Options
    {
        ...
        private IDictionary<string, Option> shortOpts = new Dictionary<string, Option>();

        /** a map of the options with the long key */
        private IDictionary<string, Option> longOpts = new Dictionary<string, Option>();

        /** a map of the required options */
        private IList<object> requiredOpts = new List<object>();

        /** a map of the option groups */
        private IDictionary<string, OptionGroup> optionGroups = new Dictionary<string, OptionGroup>();
        ...
        public Options addOptionGroup(OptionGroup group)
        {
            ...
            foreach (var option in group.getOptions())
            {
         ...
         */
        internal IList<OptionGroup> getOptionGroups()
        {
            return new List<OptionGroup>(optionGroups.Values).RemoveDuplicated();
        }
