...
namespace org.apache.commons.cli
{
    ...
    public class PatternOptionBuilderTest
    {
        ...
        public void testSimplePattern()
        {
            ...
            Assert.AreEqual(new FileInfo("build.xml").ToString(), line.getOptionObject("e").ToString(), "file flag e");
            ...
            try
            {
                Assert.AreEqual(new FileInfo[0], line.getOptionObject('m'), "files flag m");
        ...
        public void testExistingFilePattern()
        {
            ...
            Assert.AreEqual(new FileInfo("test.properties").ToString(), line.getOptionObject("f").ToString(), "f value");
