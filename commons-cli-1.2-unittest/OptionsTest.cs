...
namespace org.apache.commons.cli
{
    ...
    public class OptionsTest
    {
        ...
        public void testHelpOptions()
        {
            ...
            IList<Option> helpOptions = options.helpOptions();
        ...
        public void testToString()
        {
            ...
            Assert.IsTrue(s.ToLower().IndexOf("foo") != -1, "foo option missing");
            Assert.IsTrue(s.ToLower().IndexOf("bar") != -1, "bar option missing");
        }
